...
> **Disclaimer:** The `results.ipynb` notebook, `evaluations.py`, and `harte_to_abc_dict.py` were developed with assistance from Claude (claude.ai/code). `harte_to_abc_dict.py` used Claude to help with the translation dictionary mapping and human-fixed/verified.
